...
// CrainDoc serialization

void CrainDoc::Serialize(CArchive& ar)
{
	if (ar.IsStoring())
	{
...
void CrainDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
void CrainDoc::InitializeSearchContent()
{
...
void CrainDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
